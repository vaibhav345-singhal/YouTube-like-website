                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="osahan-form">
                                <form method="post" action="cimage_process.jsp?channel_code=<%=channel_code%>"  enctype="multipart/form-data">
                                    <div class="row">

                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label for="e1">Choose image <i class="fas fa-file-upload text-primary fa-2x"></i> </label>
