        ...
        <div id="wrapper">
            ...
            <div class="single-channel-page" id="content-wrapper">
                <div class="single-channel-image">
                    <img class="img-fluid" alt="" style="width: 1500px; height: 386px" src="cprofile/<%=channel_code%>.jpg"
                ...
                <div class="single-channel-nav">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            %>
                            <div class="float-right"><button id="subs-btn" class="btn btn-danger" type="button">Unsubscribe</button></div>
                            <%} else {%>
                        ...
                        <div class="row">
                            ...
                            <%
                                try {
                                    ...
                                    Connection cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/youtube", "root", "");
                                    Statement st = cn.createStatement();
                                    ResultSet rs = st.executeQuery("select * from videos where channel_code='" + channel_code + "'");
                                    while (rs.next()) {
                        ...
                        <div class="row">
                            ...
                            <%
                                try {
                                    ...
                                    Connection cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/youtube", "root", "");
                                    Statement st = cn.createStatement();
                                    ResultSet rs = st.executeQuery("select * from channel where code = '" + chn_code + "'");
                                    while (rs.next()) {
                                        ...
                                        String country = null;
                                        PreparedStatement ptst = cn.prepareStatement("select country from users where code = '" + chn_code + "'");
                                        ...
                                        int s_count = 0;
                                        PreparedStatement pst3 = cn.prepareStatement("select count(*) from subscribe where channel_code='" + chn_code + "'");
                                        ResultSet rst3 = pst3.executeQuery();
                                        if (rst3.next()) {
