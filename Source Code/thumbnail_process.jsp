...
<%
    ...
    try{
       // FileOutputStream fileOut = new FileOutputStream("C:/Users/ankit/Documents/NetBeansProjects/YouTube/build/web/thumbnail/"+saveFile);
    ...
    // fileOut.write(dataBytes);
      ...
      response.sendRedirect("thumbnail.jsp?cat_code='"+cat_code+"'&v_code='"+v_code+"'&error=1");
}
