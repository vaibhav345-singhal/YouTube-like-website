            ...
            <div id="content-wrapper">
                <div class="container-fluid pb-0">
                    <div class="row">
                        ...
                        <%                            try {
                                ...
                                Connection cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/youtube", "root", "");
                                Statement st = cn.createStatement();
                                ResultSet rs = st.executeQuery("select count(title) from videos where email= '" + email + "'");
                                if (rs.next()) {
                                    v_count = rs.getInt(1);
                                }
                                PreparedStatement pst = cn.prepareStatement("select count(distinct(category)) from videos where email='" + email + "'");
                                ResultSet rst = pst.executeQuery();
                                if (rst.next()) {
                                    c_count = rst.getInt(1);
                                }

                                PreparedStatement pst1 = cn.prepareStatement("select c_name from channel where email='" + email + "'");
                                ResultSet rst1 = pst1.executeQuery();
                                if (rst1.next()) {
                                    channel_name = rst1.getString(1);
                                }
                        %>
                        ...
                        <div class="col-xl-4 col-sm-6 mb-3">
                            <div class="card text-white bg-danger o-hidden h-100 border-none">
                                <div class="card-body">
                                    ...
                                    <div class="mr-5"><%=channel_name%></div>
                                </div>
                                <a class="card-footer text-white clearfix small z-1" href="channel.jsp">
                                    <span class="float-left" style="font-size: 15px;">View Details</span>
                        ...
                        <div class="col-xl-4 col-sm-6 mb-3">
                            <div class="card text-white bg-warning o-hidden h-100 border-none">
                                <div class="card-body">
                                    ...
                                    <div class="mr-5"><b><%=v_count%></b> Videos</div>
                                </div>
                                <a class="card-footer text-white clearfix small z-1" href="channel.jsp">
                                    <span class="float-left" style="font-size: 15px;">View Details</span>
                                    <span class="float-right">
                        ...
                        <div class="col-xl-4 col-sm-6 mb-3">
                            <div class="card text-white bg-success o-hidden h-100 border-none">
                                <div class="card-body">
                                    ...
                                    <div class="mr-5"><b><%=c_count%></b> Categories</div>
                                </div>
                                <a class="card-footer text-white clearfix small z-1" href="channel.jsp">
                                    <span class="float-left" style="font-size: 15px;">View Details</span>
                                    <span class="float-right">
                    ...
                    <%
                        try {
                            ...
                            PreparedStatement pst2 = con.prepareStatement("select * from users where email ='" + email + "'");
                            ResultSet rst2 = pst2.executeQuery();
                            if (rst2.next()) {
                                String fname = rst2.getString(3);
                                String lname = rst2.getString(4);
                                String country = rst2.getString(7);
                                String ch_code = rst2.getString(2);
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control border-form-control" value="" placeholder=<%=fname%> disabled=""  type="text">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control border-form-control" value="" placeholder=<%=lname%> disabled="" type="text">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control border-form-control " value="" placeholder=<%=country%> disabled="" type="email">
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-11 text-right">
                        <a href="edit_profile.jsp" type="button" class="btn btn-success border-none">  Edit Details </a>&nbsp;&nbsp;
                        <a href="edit_pimage.jsp?chn_code=<%=ch_code%>" type="button" class="btn btn-success border-none">  Change Profile pic </a>
                    </div>
