                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="osahan-form">
                                <form method="post" action="upload_process.jsp">
                                    <div class="row">

                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label for="e1">Video Title</label>
                                                <input type="text" name="title" placeholder="Title" id="e1" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label for="e2">About</label>
                                                <textarea style="resize: none;" maxlength="100000" rows="3" id="e2" name="description" class="form-control" placeholder="Description"></textarea>
                                            </div>
                                        </div>
