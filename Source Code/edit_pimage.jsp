...
<%
    String channel_code = request.getParameter("chn_code");
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="osahan-form">
                                <form method="post" action="edit_pimage_process.jsp?channel_code=<%=channel_code%>"  enctype="multipart/form-data">
                                    <div class="row">

                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label for="e1">Choose pic <i class="fas fa-file-upload text-primary fa-2x"></i> </label>

                                                <input type="file" name="pimage"  id="e1" class="form-control">
                                            </div>
                                        </div>
