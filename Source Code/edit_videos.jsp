                    ...
                    <div class="video-block section-padding">
                        <div class="row">
                            ...
                            <%                                try {
                                    Class.forName("com.mysql.jdbc.Driver");
                                    Connection cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/youtube", "root", "");
                                    PreparedStatement pst = cn.prepareStatement("select * from `videos` where email='" + email + "'");
                                    ResultSet rst = pst.executeQuery();
                                    while (rst.next()) {
                                        String v_code = rst.getString(2);
                                        String cat_code = rst.getString(5);
                                        String user = rst.getString(8);
                                        String title = rst.getString(3);
                                        String channel_code = rst.getString(9);
                            %>
                                ...
                                <div class="video-card">
                                    ...
                                    <div class="video-card-body">
                                        ...
                                        <div class="video-view">
                                            <div class="channels-card-image-btn"><a href="edit_videos_process.jsp?v_code=<%=v_code%>&cat_code=<%=cat_code%>"  type="button" class="btn btn-danger btn-sm border-none"><i  class="fas fa-edit"></i></a>&nbsp;
                                                <a href="delete_upload_process.jsp?v_code=<%=v_code%>"  type="button" class="btn btn-warning btn-sm border-none"><i  class="fas fa-times-circle"></i></a></div>
                                        </div>
