...
<%
    ...
    try{
        FileOutputStream fileOut = new FileOutputStream(request.getRealPath("/")+"/cprofile/"+saveFile);
    ...
    // fileOut.write(dataBytes);
      ...
      response.sendRedirect("upload_cimage.jsp?channel_code="+channel_code+"&error=1");
}
