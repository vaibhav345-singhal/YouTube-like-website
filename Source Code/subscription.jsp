...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="load-subs" >
                                ...
                                <div class="owl-carousel owl-carousel-category">
                                    <%  String channel_code = null;
                                        ...
                                        try {
                                            Class.forName("com.mysql.jdbc.Driver");
                                            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/youtube", "root", "");
                                            PreparedStatement ps = cn.prepareStatement("select * from subscribe where user='" + email + "'");
                                            ResultSet rs = ps.executeQuery();

                                            while (rs.next()) {
                                                channel_code = rs.getString(2);

                                                PreparedStatement ptst = cn.prepareStatement("select count(*) from subscribe where channel_code='" + channel_code + "'");
                                                ResultSet rtst = ptst.executeQuery();
                                                if (rtst.next()) {
                                                    s_count = rtst.getInt(1);
                                                } else {
                                                    s_count = 0;
                                                }

                                                PreparedStatement pst = cn.prepareStatement("select * from channel where code='" + channel_code + "'");
                                    ...
                                    <div class="item">
                                        <div class="category-item">
                                            <a href="all_channel.jsp?channel_code=<%=channel_code%>">
                                                <img class="img-fluid" src="profile/<%=channel_code%>.jpg" alt="">
                                                <h6><%=rst.getString(3)%> <span title="" data-placement="top" data-toggle="tooltip" data-original-title="Verified"><i class="fas fa-check-circle text-success"></i></span></h6>
                                                <p><%=s_count%> subscribers</p>
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <%  String cat_code = null;
                                ...
                                try {
                                    ...
                                    PreparedStatement ptst = cn.prepareStatement("select * from subscribe where user='" + email + "'");
                                    ResultSet rtst = ptst.executeQuery();

                                    while (rtst.next()) {
                                        channel_code = rtst.getString(2);

                                        Statement st = cn.createStatement();
                                        ResultSet rs = st.executeQuery("select * from videos where channel_code ='"+channel_code+"' order by RAND()");
                                        while (rs.next()) {
