                    ...
                    <div class="row">
                        <%
                            ...
                            try {
                                ...
                                PreparedStatement pst = con.prepareStatement("select * from category where code='" + cat_code + "'");
                                ResultSet rst = pst.executeQuery();
                                if (rst.next()) {
                        %>
                        <div class="col-md-12">
                            <div class="main-title">
                                <h6><%=rst.getString(3)%>:</h6>
                            </div>
                        </div>
                        <%
                            PreparedStatement pst2 = con.prepareStatement("select * from videos where category='" + cat_code + "'");
                            ResultSet rst2 = pst2.executeQuery();
                            while (rst2.next()) {
                                String v_code = rst2.getString(2);
                                String channel_code = rst2.getString(9);
                                String title = rst2.getString(3);
                                String user = rst2.getString(8);
                                String udate = rst2.getString(7);

                                PreparedStatement pst3 = con.prepareStatement("select count(*) from views where video_code='" + v_code + "'");
                                ResultSet rst3 = pst3.executeQuery();
                                if (rst3.next()) {

                                    int count = rst3.getInt(1);

                                    String c_name = null;
                                    PreparedStatement pst4 = con.prepareStatement("select c_name from channel where code='" + channel_code + "'");
                                    ResultSet rst4 = pst4.executeQuery();
                                    if (rst4.next()) {
                                        c_name = rst4.getString(1);
                                    }
                        %>
