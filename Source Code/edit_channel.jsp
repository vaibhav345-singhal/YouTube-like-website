                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="osahan-form">
                                <form method="post" action="edit_channel_process.jsp">
                                    <div class="row">

                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label for="e1">channel Name</label>
                                                <input type="text" name="title" value="<%=name%>" id="e1" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label for="e2">About</label>
                                                <textarea style="resize: none;" maxlength="10000" rows="10" id="e2" name="description" class="form-control"><%=about%></textarea>
                                            </div>
                                        </div>
